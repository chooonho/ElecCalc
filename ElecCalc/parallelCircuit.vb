Public Class parallelCircuit
    Private Sub parallelCircuit_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Application.Exit()
    End Sub

    Private Sub parallelCircuit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        parallelOptions.ShowDialog()
    End Sub

    Private Sub lblResistVal_TextChanged(sender As Object, e As EventArgs) Handles lblResistVal.TextChanged
        Call CalculateStats(txtVoltageVal, lblResistVal, lblCurrentVal, lblPowerVal, parallelOptions, chkRounding)
    End Sub
