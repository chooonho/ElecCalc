Public Class parallelOptions
    ...
    Private Sub parallelOptions_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Hide()
    End Sub

    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Call AddResistor(cBoxA, cBoxB, cBoxC, cBoxD, listBox1, TotalResistance, False)
    End Sub

    Private Sub btnRemove_Click(sender As Object, e As EventArgs) Handles btnRemove.Click
        Call RemoveResistor(listBox1, TotalResistance, False)
    End Sub
    ...
    Private Sub parallelOptions_Paint(sender As Object, e As PaintEventArgs) Handles Me.Paint
    ...
    Private Sub parallelOptions_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Location = New Point(parallelCircuit.Location.X + parallelCircuit.Width, parallelCircuit.Location.Y)
    End Sub
End Class